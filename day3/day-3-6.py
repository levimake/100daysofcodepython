print('''
      *******************************************************************************
      ...
      __/______/______/______/__"=._o--._   ;o|o;     _._;o;____/______/______/____
...
if choice != "left" :
    ...
    if choice != "wait" :
        ...
        if choice in ["red","blue","yellow"] :
            message = "Burned by fire. Game over" if choice == "red" else "Eaten by beasts. Game over." if choice == "blue" else "You Win!"
            print(message)
        else :
